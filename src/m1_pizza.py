...
def run_test_draw_points_on_circle():
    ...
    circle = rg.Circle(rg.Point(300, 300), 225)
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 4:  5 slices, thin (thickness=4) black lines.'
    window = rg.RoseWindow(800, 800, title)
    circle = rg.Circle(rg.Point(400, 400), 300)
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    for k in range(len(points)-1):
        ...
        line.color = color
        line.attach_to(window)
    line2 = rg.Line(points[len(points)-1], points[0])
